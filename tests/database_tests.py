...
class DatabaseTest(unittest.TestCase):
    def setUp(self):
        self.database = Database('/home/leo/PycharmProjects/CrAB/tests/testdb', True)
    ...
    def test_db_get_put_binary(self):
        ...
        self.assertEqual(self.data, data_from_db, 'binary data is not equal, something wrong with put_block or get_block')
